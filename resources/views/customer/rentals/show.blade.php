...
@php
    ...
    $adminPhone = $admin ? $admin->phone : '081230054652'; // Fallback
                            ...
                            <div class="ot-content-body p-4" id="otWrapper">
                                ...
                                @elseif($ot->status === 'pending')
                                    <div class="text-center py-3" id="otApp" data-status="pending" data-id="{{ $ot->id }}">
                                        ...
                                        <div class="d-flex gap-2 mt-3">
                                            <a href="https://wa.me/{{ $cleanPhone }}" class="btn btn-success flex-grow-1 fw-bold rounded-3" target="_blank">
                                ...
                                @elseif($ot->status === 'rejected')
                                    <div class="text-center py-2 animate__animated animate__shakeX">
                                        ...
                                        <div class="d-flex gap-2 mt-3">
                                            <a href="https://wa.me/{{ $cleanPhone }}?text=Halo%20Admin%20HK%20Equipment,%20saya%20ingin%20menanyakan%20terkait%20penolakan%20lembur%20unit%20{{ $rental->equipment->name }}" 
