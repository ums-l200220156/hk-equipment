...
class OvertimeController extends Controller
{
    ...
    /**
     * PERBAIKAN DISINI: Menghapus pengajuan pending ATAU notifikasi rejected
     */
    public function cancel($id)
    {
        $overtime = Overtime::where('id', $id)
            // Sekarang bisa menghapus data yang statusnya pending ATAU rejected
        ...
        return back()->with('success', 'Riwayat pengajuan lembur berhasil dibersihkan.');
    }
